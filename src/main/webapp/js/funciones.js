...
var Cms = {
    loadingscreen: function (txt) {
        $('.ls1').remove()
        $('.ls2').remove()
        var bgfondo = $('<div>').attr('class', 'ls1');
        $('body').css("overflow", "hidden!important;");
        $('body').css("clear", "both");
        $('body').append(bgfondo);
        $('.ls1').css("height", getheight());
        $('.ls2').css("height", getheight());
        var contenido = $('<div>').attr('class', 'ls2');
        $('body').append(contenido);
        $('body').css("overflow-y", 'hidden');
        $('body').css("overflow-x", 'hidden');
        //$('.g2').html('html').hide().fadeIn('slow')
        $('.ls2').css("overflow-y", 'auto');
        $('.ls2').html('<span style="text-align:center;display:block;"><div class="spinner-grow" style="width: 3rem; height: 3rem;" role="status"><span class="sr-only">Loading...</span></div></span><br/><span style="font-family: arial, sans-serif;font-weight: bold;">' + txt + '</span>').hide().fadeIn('slow');
        /*$('.gclose').bind('click', function () {
         $('.ls1').fadeOut(300, function () {
         $().remove(this);
         Cms.restoreY();
         });
         $('.ls2').fadeOut(300, function () {
         $().remove(this);
         Cms.restoreY();
         });
         });*/
        ...
        $('.ls2').css("width", 'auto');
        $('.ls2').css("max-height", ($(window).height() - 150) + 'px');
        $('.ls2').css("height", 'auto');
        $('.ls2').css("left", '50%');
        $('.ls2').css("top", ($(window).scrollTop() + 60) + 'px');
        $('.ls2').css("margin-left", [-($('.ls2').width() / 2)] - 15);
        $('.ls2').css('visibility', 'visible');
