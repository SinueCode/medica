...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title titlea" id="exampleModalLabel">Modal title</h5>
            ...
            <div class="notif-content-l" style="">
                <div class="notif-list-l menuleft hmenu-translateX-center" style="">
                    <ul class="ulmenu">
                        ...
                        <hr/>
                        <%if (session.getAttribute("user_oficios").toString().equals("1")) {
                        %>
                        <!--ENTREGA DE GUARDIA-->
                        <li>
                            <div class="subcat">
